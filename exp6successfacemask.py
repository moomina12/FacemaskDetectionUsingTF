...
mask_model = load_model(r"C:\Users\HP\mask6_detector.model.h5")
...
def detect_and_predict_mask(frame, face_net, mask_model):
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > 0.3:  # Lowered threshold to 0.3 to detect smaller faces
            ...
            #face = cv2.resize(face, (128, 128))  # Adjust the input size as per your model
            face = cv2.resize(face, (224, 224))  # changed above code as above was giving error
